      ...
      <div className="flex-1 flex flex-col items-center justify-center p-5">
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">Sign in to your habits</p>
          </div>
          ...
          <p className="mt-5 text-center text-sm text-gray-500">
            New here?{' '}
            <a href="/signup" className="font-semibold text-indigo-600 hover:text-indigo-700 hover:underline underline-offset-2">
              Create an account
            </a>
          </p>
        </div>
